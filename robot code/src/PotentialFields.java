...
public class PotentialFields {
    ...
    private final int enEucId;
    private final int enFracId;
    ...
    public PotentialFields() {
        ...
        enEucId = gui.addButton(7, 4, "Euclidean", this, "enableEuclidean");
        enFracId = gui.addButton(7, 5, "Fractional", this, "enableFractional");
        gui.setButtonEnabled(enEucId, false);
        ArcPlanner = -1;
...
//		
    ...
    private void setArcPlanner(int planar) {
        ...
        switch (planar) {
            case 0:
                ...
                gui.setButtonEnabled(enEucId, true);
                gui.setButtonEnabled(enFracId, true);
                break;
            case 1:
            ...
            case 2:
                ...
                gui.setButtonEnabled(enArcId, true);
                gui.setButtonEnabled(enEucId, true);
                gui.setButtonEnabled(enFracId, false);
                break;
            default:
...
//                
    ...
    public void goLittleRobot(IntPoint start, IntPoint goal, int goalRad, int robotRadius, int robotSensorRange,
        ...
        while (!rob.inGoal()) {
            ...
            boolean move = ArcPlanner == 0 ? rob.ArcMove() : (ArcPlanner == 1 ? rob.move() : rob.FracMove()); // Move 1 step
